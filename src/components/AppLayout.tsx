...
const DEFAULT_MENU_VISIBILITY = {
  ...
  hr_adjustments: true,
  hr_payroll: true,
  hr_salary_slips: true,
  pm_section: false,
  pm_messages: true,
  pm_manage_articles: true,
  pm_create_article: true,
  pm_deleted_articles: true,
  pm_material_library: true,
  pm_cost_analysis: true,
                      ...
                      {[
                        ...
                        },
                        {
                          ...
                          items: [
                            ...
                            { key: 'po_supervisor', label: 'PO Material Receive', icon: '🔍' },
