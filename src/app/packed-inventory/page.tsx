    ...
    <div style={{ background: '#e2e8f0', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 20px' }} className="print-wrapper">
      ...
      <div className="sticker-wrap" style={{ padding: '20px', display: 'flex', justifyContent: 'center', width: '100%', overflow: 'auto' }}>
        <div className="jokot-sticker" style={{
          ...
          {!isJokot && (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1.5px solid #000', overflow: 'hidden', boxSizing: 'border-box', margin: 0, padding: 0, background: '#fff' }}>
              <img
                src="/lunars-logo-black.jpg"
                alt="Lunar's"
                style={{
                  width: 'auto',
                  height: '1.2cm',
          ...
          <div style={{ display: 'flex', alignItems: 'stretch', overflow: 'hidden', boxSizing: 'border-box', margin: 0, padding: 0 }}>
            ...
            <div style={{ flex: 1.15, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 3px', overflow: 'hidden', boxSizing: 'border-box' }}>
              ...
              <div style={{ fontSize: designStyle === '2' ? '9.5px' : '8px', fontWeight: 800, margin: 0, padding: 0, lineHeight: 1.1 }}>{isJokot ? 'Ph: +91 8867915043, Email: jokot.international@gmail.com' : 'Customer Care: 9843588136, Email: vikingcbe@lunars.com'}</div>
            </div>
          </div>
        </div>
      </div>
